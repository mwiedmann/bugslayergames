...
export const gameList: IGameData[] = [
  {
    imageSrc: 'images/portfolio/SpheraTurris.png',
    title: 'Sphera Turris',
  ...
  {
    imageSrc: 'images/portfolio/Waterfall.png',
    title: 'Waterfall',
  ...
  {
    imageSrc: 'images/portfolio/Gobblers.jpg',
    title: 'Gobblers',
